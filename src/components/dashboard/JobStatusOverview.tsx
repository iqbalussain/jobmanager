      ...
      <div className="grid grid-cols-2 gap-3 h-full">
        ...
        >
          <CardContent className="p-3 flex flex-col items-center justify-center text-center h-full">
            <Briefcase className="w-5 h-5 text-blue-200 mb-1" />
        ...
        >
          <CardContent className="p-3 flex flex-col items-center justify-center text-center h-full">
            <Activity className="w-5 h-5 text-orange-200 mb-1" />
        ...
        >
          <CardContent className="p-3 flex flex-col items-center justify-center text-center h-full">
            <Clock className="w-5 h-5 text-purple-200 mb-1" />
        ...
        >
          <CardContent className="p-3 flex flex-col items-center justify-center text-center h-full">
            <Activity className="w-5 h-5 text-yellow-200 mb-1" />
        ...
        >
          <CardContent className="p-3 flex flex-col items-center justify-center text-center h-full">
            <Palette className="w-5 h-5 text-indigo-200 mb-1" />
        ...
        >
          <CardContent className="p-3 flex flex-col items-center justify-center text-center h-full">
            <CheckCircle className="w-5 h-5 text-green-200 mb-1" />
        ...
        >
          <CardContent className="p-3 flex flex-col items-center justify-center text-center h-full">
            <XCircle className="w-5 h-5 text-red-200 mb-1" />
