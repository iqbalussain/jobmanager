...
const ICON_MAP: Record<StatusKey, JSX.Element> = {
  total: <Briefcase className="w-5 h-5 inline-block mr-2 -mt-1 text-foreground" />,
  pending: <Clock className="w-5 h-5 inline-block mr-2 -mt-1 text-foreground" />,
  "in-progress": <Play className="w-5 h-5 inline-block mr-2 -mt-1 text-foreground" />,
  designing: <Pencil className="w-5 h-5 inline-block mr-2 -mt-1 text-foreground" />,
  completed: <CheckCircle className="w-5 h-5 inline-block mr-2 -mt-1 text-foreground" />,
  invoiced: <FileText className="w-5 h-5 inline-block mr-2 -mt-1 text-foreground" />,
  cancelled: <XCircle className="w-5 h-5 inline-block mr-2 -mt-1 text-foreground" />,
};
