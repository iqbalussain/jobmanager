...
export function DailyTrendsChart({ dailyJobData, isLoading }: DailyTrendsChartProps) {
  ...
  return (
    <Card className="shadow-xl border-0 bg-gradient-to-br from-violet-900 to-violet-800 text-white">
      ...
      <CardContent className="h-[320px] md:h-[100%] relative">
        {/* Neon SVG filter */}
        ...
        {isLoading ? (
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={dailyJobData}>
              ...
              <XAxis dataKey="day" stroke="#E5E7EB" tick={{ fill: "#23f4ff", fontWeight: 600 }} />
              <YAxis stroke="#E5E7EB" tick={{ fill: "#23f4ff", fontWeight: 600 }} />
              <Tooltip
                contentStyle={{
                ...
                cursor={{ stroke: neonColor, strokeWidth: 2, opacity: 0.5 }}
              />
              <Line
                type="monotone"
                dataKey="jobs"
