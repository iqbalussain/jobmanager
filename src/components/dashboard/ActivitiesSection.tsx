...
export function ActivitiesSection() {
  ...
  return <Card className="shadow-xl border-0 glass-card h-full flex flex-col overflow-hidden">
      ...
      <CardContent className="pt-2 flex-0 overflow-y-hidden flex-auto ">
        <div className={`
          ...
          <div className="space-y-3">
            {isLoading ? <div className="text-center text-gray-500">Loading activities...</div> : activities.length > 0 ? activities.map(activity => {
