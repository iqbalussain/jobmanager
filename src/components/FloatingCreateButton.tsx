  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full button-gradient text-white shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
