...
export function ApprovedJobsList({ jobs, onStatusUpdate }: ApprovedJobsListProps) {
    ...
    <div className="space-y-6 p-6 bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Jobs that have been approved and are in progress</p>
        </div>
      </div>
