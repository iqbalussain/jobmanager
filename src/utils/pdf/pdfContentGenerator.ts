  ...
  return `
    <div style="font-family: Arial, sans-serif; font-size: 12px; color: #333; padding: 20px;">
      <div style="text-align: center; margin-bottom: 20px;">
        <h1 style="margin: 0; font-size: 20px; color: #0050b3;">CLIENT: ${job.customer}</h1>
      ...
      <div style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; border-radius: 6px;">
        <div style="font-weight: bold; text-decoration: underline; margin-bottom: 6px;">Customer & Team</div>
      ...
      <div style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; border-radius: 6px;">
        <div style="font-weight: bold; text-decoration: underline; margin-bottom: 6px;">Timeline & Details</div>
        <table style="width: 100%; border-collapse: collapse;">
      ...
      <div style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; border-radius: 6px;">
        <div style="font-weight: bold; text-decoration: underline; margin-bottom: 6px;">Job Order Details</div>
        <p style="white-space: pre-wrap;">
          ${job.jobOrderDetails || 'No additional details provided.'}
        </p>
      </div>

      <div style="text-align: center; font-size: 10px; color: #666; margin-top: 20px; padding-top: 10px; border-top: 1px solid #ddd;">
